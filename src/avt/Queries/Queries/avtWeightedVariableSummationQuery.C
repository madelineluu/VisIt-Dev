...
avtWeightedVariableSummationQuery::ApplyFilters(avtDataObject_p inData)
{
    ...
    if(topo == 0)
    {
        ...
        // Points are weighted equally, so this is already the arithmetic mean.
        weightDescriptor = "";
    }
    else if (topo == 1)
    {
    ...
    else if (topo == 2)
    {
        ...
        else 
        {
            ...
            weightDescriptor = "revolved-volume";
        }
    }
    else
    {
